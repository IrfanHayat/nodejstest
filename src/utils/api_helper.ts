...
export const updateModel = (ModelClass) => async (req, res, next) => {
  ...
  const protectedFields = ModelClass.protectedFields
    ? ModelClass.protectedFields()
    : [];
...
export const addSubDocToModel = (ModelClass, fieldName) => async (
  req,
  res,
  next
) => {
...
export const removeSubDocToModel = (ModelClass, fieldName) => async (
  req,
  res,
  next
) => {
